...
<h3 data-importer="text" align="center">Hello, My Name Is Lucas Dias, i´m an academic tecnology student start begin in techonology area with focus in improve my skills in areas how likes Artificial Inteligence and Data Area</h3>

###

<h4 data-importer="text" align="left">🖥️ About Me(Sobre mim)<br>===========================================================================================<br>➡️ Acadêmico sem experiência profissional tentando engressar na área de tecnologia com foco em conhecer sobre a área de Suporte De TI (help desk) suporte ao usuário e Analise Dados Sobre IA(inteligência artificial) e DataScience(Ciência de Dados).<br>===========================================================================================<br>➡️ 2026 - Presente | Bacharelado em Sistema de Informação No Instituto Federal Catarinense (Cursando)<br><br>➡️ inglês intermediário(A1-A2) (Formado mas constantemente melhorando).<br><br>➡️Formado Em Montagem e Manutenção De Computadores<br>em (CASA Brasil) <br><br>➡️ Habilidades Computacionias Com Sistemas Windows e LINUX , tenho facilidade em me adaptar <br>em qualquer sistema operacional.</h4>
